    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "role",
                    models.ForeignKey(on_delete=models.CASCADE, related_name="role_assignments", to="accounts.role"),
                ),
                (
                    "user",
                    models.ForeignKey(on_delete=models.CASCADE, related_name="user_roles", to=settings.AUTH_USER_MODEL),
                ),
            ],
            options={
